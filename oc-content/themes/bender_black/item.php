<?php
    ...
    bender_black_add_boddy_class('item');
...
<div id="item-content">
    ...
    <?php if( osc_images_enabled_at_items() ) { ?>
        ...
        <div class="item-photos">
            <a href="<?php echo osc_resource_url(); ?>" class="main-photo" rel="image_group" title="<?php _e('Image', 'bender_black'); ?> <?php echo $i+1;?> / <?php echo osc_count_item_resources();?>">
                <img src="<?php echo osc_resource_url(); ?>" alt="<?php echo osc_item_title(); ?>" title="<?php echo osc_item_title(); ?>" />
            </a>
            <div class="thumbs">
                <?php for ( $i = 0; osc_has_item_resources(); $i++ ) { ?>
                <a href="<?php echo osc_resource_url(); ?>" rel="image_group" title="<?php _e('Image', 'bender_black'); ?> <?php echo $i+1;?> / <?php echo osc_count_item_resources();?>">
